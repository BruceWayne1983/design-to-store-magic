...
const WhyDifferent = () => (
  <section className="w-full bg-background py-28 px-16 border-t border-border">
    <div className="max-w-[1280px] mx-auto flex flex-col gap-12">
      <SectionHeader heading="Why GLYCO8™ is different" text="Advanced glucose control beyond basic GDAs." />
      <div className="grid grid-cols-3 gap-8">
        {features.map((f) => (
          <div key={f.title} className="flex flex-col items-center text-center gap-4 border border-border rounded-lg p-8">
