...
const footerLinks = [
  ...
  { title: "Science", links: [{ label: "Knowledge Base", href: "/knowledge-base" }, { label: "Research", href: "/blog" }, { label: "Articles", href: "/blog" }] },
  { title: "Company", links: [{ label: "About", href: "/about" }, { label: "Contact", href: "/contact" }, { label: "The App", href: "/app" }] },
