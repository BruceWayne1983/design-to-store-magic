...
export const products: Record<string, ProductData> = {
  ...
  "h2o-go": {
    ...
    format: "20 × 5g Stick Packs | 20 Servings",
    price: "£19.99",
    ...
    suggestedUse: "Empty one stick into 500ml of cold water, shake or stir until dissolved. Take 1–2 sticks per day. Use one stick 20 minutes before training and another during or after long sessions.",
    supplementSummary: "Sodium 1,000mg · Potassium 200mg · Magnesium (Bisglycinate) 60mg · Chloride 1,500mg · Vitamin C 80mg — per 5g stick.",
    ...
    supplementRows: [
      { ingredient: "Sodium", spec: "(from chloride & citrate)", dose: "1,000 mg", purpose: "Primary electrolyte for rehydration", flag: "" },
      { ingredient: "Chloride", spec: "", dose: "1,500 mg", purpose: "Fluid balance & gastric absorption", flag: "" },
      { ingredient: "Potassium", spec: "(citrate)", dose: "200 mg", purpose: "Intracellular electrolyte & cramp prevention", flag: "", nrv: "10%" },
      { ingredient: "Magnesium", spec: "(bisglycinate)", dose: "60 mg", purpose: "Nerve & muscle function", flag: "", nrv: "16%" },
      { ingredient: "Vitamin C", spec: "(ascorbic acid)", dose: "80 mg", purpose: "Antioxidant & immune support", flag: "", nrv: "100%" },
    ],
    clinicalMechanisms: [
